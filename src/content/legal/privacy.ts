    ...
    sections: [
        ...
        body: [
          ...
          },
          {
            ...
            items: [
              ...
              'PostHog, untuk analitik produk pada halaman pemasaran dan aplikasi kami.',
            ],
          },
          {
            type: 'p',
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'Kami juga menggunakan PostHog untuk analitik produk, agar dapat memahami bagaimana halaman pemasaran dan aplikasi kami digunakan. PostHog menyimpan pengenal semu (pseudonim) di penyimpanan lokal peramban Anda, bukan dalam cookie. Kami tidak mengirimkan nama, email, atau nomor telepon Anda ke PostHog, kami tidak merekam sesi layar Anda, dan kami tidak menggunakan data ini untuk iklan.',
          },
          {
            type: 'p',
    ...
    sections: [
        ...
        body: [
          ...
          },
          {
            ...
            items: [
              ...
              'PostHog, for product analytics on our marketing and application pages.',
            ],
          },
          {
            type: 'p',
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'We also use PostHog for product analytics, to understand how our marketing and application pages are used. PostHog stores a pseudonymous identifier in your browser local storage, not in a cookie. We do not send your name, email, or phone number to PostHog, we do not record your screen sessions, and we do not use this data for advertising.',
          },
          {
            type: 'p',
