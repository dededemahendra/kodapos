    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'Kami juga menggunakan PostHog untuk analitik produk dan pelacakan kesalahan teknis, agar dapat memahami bagaimana halaman pemasaran dan aplikasi kami digunakan dan agar dapat memperbaiki kesalahan yang Anda temui. PostHog menyimpan pengenal semu (pseudonim) di penyimpanan lokal peramban Anda, bukan dalam cookie. Kami tidak mengirimkan nama, email, atau nomor telepon Anda ke PostHog, kami tidak merekam sesi layar Anda, dan kami tidak menggunakan data ini untuk iklan. Laporan kesalahan berisi pesan kesalahan dan jejak kode (stack trace); alamat email dan nomor telepon dihapus dari pesan tersebut di peramban Anda sebelum dikirim.',
          },
          {
            type: 'p',
    ...
    sections: [
        ...
        body: [
          { type: 'p', text: 'We collect the following types of data:' },
          {
            ...
            items: [
              ...
              'Error diagnostic data: when the application hits a technical error, we collect the error type, the error message, the stack trace, and the page it happened on, so that we can fix it. Email addresses and phone numbers are automatically removed from error messages in your browser before the data is sent.',
            ],
          },
        ],
      },
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'We also use PostHog for product analytics and technical error tracking, to understand how our marketing and application pages are used and to fix the errors you run into. PostHog stores a pseudonymous identifier in your browser local storage, not in a cookie. We do not send your name, email, or phone number to PostHog, we do not record your screen sessions, and we do not use this data for advertising. Error reports contain the error message and stack trace; email addresses and phone numbers are removed from those messages in your browser before they are sent.',
          },
          {
            type: 'p',
