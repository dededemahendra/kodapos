    ...
    sections: [
        ...
        body: [
          { type: 'p', text: 'Kami mengumpulkan jenis data berikut:' },
          {
            ...
            items: [
              ...
              'Data analitik penggunaan: peristiwa kunjungan halaman dan interaksi pada halaman pemasaran serta aplikasi kami, yang dikaitkan dengan pengenal semu (pseudonim), bukan dengan nama atau email Anda.',
              'Data diagnostik kesalahan: ketika aplikasi mengalami kesalahan teknis, kami mengumpulkan jenis kesalahan, pesan kesalahan, jejak kode (stack trace), dan halaman tempat kesalahan terjadi, agar kami dapat memperbaikinya. Alamat email dan nomor telepon dihapus secara otomatis dari pesan kesalahan di peramban Anda sebelum data dikirim, meskipun kami tidak dapat memastikan bahwa pesan tersebut tidak memuat kata lain yang tidak kami perkirakan.',
            ],
          },
        ],
      },
        ...
        body: [
          ...
          },
          {
            ...
            items: [
              ...
              'PostHog, untuk analitik produk dan pelacakan kesalahan teknis pada halaman pemasaran dan aplikasi kami.',
            ],
          },
          {
            type: 'p',
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'Kami juga menggunakan PostHog untuk analitik produk dan pelacakan kesalahan teknis, agar dapat memahami bagaimana halaman pemasaran dan aplikasi kami digunakan dan agar dapat memperbaiki kesalahan yang Anda temui. PostHog menyimpan pengenal semu (pseudonim) di penyimpanan lokal peramban Anda, bukan dalam cookie. Peristiwa analitik tidak memuat nama, email, atau nomor telepon Anda, kami tidak merekam sesi layar Anda, dan kami tidak menggunakan data ini untuk iklan. Laporan kesalahan berbeda, karena teks kesalahan ditulis oleh perangkat lunak dan bukan kami tentukan sendiri: laporan itu memuat pesan kesalahan dan jejak kode (stack trace). Alamat email dan nomor telepon dihapus secara otomatis dari teks tersebut di peramban Anda sebelum dikirim, tetapi kami tidak dapat memastikan bahwa pesan kesalahan tidak memuat nama atau kata lain yang tidak kami perkirakan.',
          },
          {
            type: 'p',
            text: 'Analitik tidak dijalankan pada halaman yang ditujukan bagi pelanggan akhir, yaitu halaman pesan mandiri, papan menu, dan layar tampilan pelanggan. Kami juga menghormati pengaturan Do Not Track pada peramban Anda.',
          },
        ],
      },
      {
    ...
    sections: [
        ...
        body: [
          { type: 'p', text: 'We collect the following types of data:' },
          {
            ...
            items: [
              ...
              'Usage analytics data: page view and interaction events on our marketing and application pages, linked to a pseudonymous identifier rather than to your name or email.',
              'Error diagnostic data: when the application hits a technical error, we collect the error type, the error message, the stack trace, and the page it happened on, so that we can fix it. Email addresses and phone numbers are automatically removed from error messages in your browser before the data is sent, though we cannot rule out that a message contains other wording we did not anticipate.',
            ],
          },
        ],
      },
        ...
        body: [
          ...
          },
          {
            ...
            items: [
              ...
              'PostHog, for product analytics and technical error tracking on our marketing and application pages.',
            ],
          },
          {
            type: 'p',
      ...
      },
      {
        ...
        body: [
          ...
          {
            type: 'p',
            text: 'We also use PostHog for product analytics and technical error tracking, to understand how our marketing and application pages are used and to fix the errors you run into. PostHog stores a pseudonymous identifier in your browser local storage, not in a cookie. Analytics events do not include your name, email, or phone number, we do not record your screen sessions, and we do not use this data for advertising. Error reports work differently, because the text of an error is written by the software rather than chosen by us: they contain the error message and the stack trace. We automatically remove email addresses and phone numbers from that text in your browser before it is sent, but we cannot rule out that an error message contains a name or other wording we did not anticipate.',
          },
          {
            type: 'p',
            text: 'Analytics does not run on pages intended for end customers, meaning self ordering pages, the menu board, and the customer display screen. We also respect your browser Do Not Track setting.',
          },
        ],
      },
      {
