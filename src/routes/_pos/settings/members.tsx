  ...
  return (
    <div className="grid gap-2">
      {outlets.map((o) => (
        ...
        >
          <Checkbox checked={checked.has(o.cafeId)} onCheckedChange={() => toggle(o.cafeId)} />
        ...
        >
          ...
          <div className="space-y-2">
            ...
            {outlets.length === 0 ? (
              ...
              <OutletCheckboxList outlets={outlets} checked={checkedCafeIds} toggle={toggle} />
            )}
          </div>
          <DialogFooter>
            <Button
            ...
            <Button type="submit" disabled={submitting || checkedCafeIds.size === 0}>
...
function EditOutletsDialog({
  ...
  return (
    <Dialog open={!!member} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{member ? t`Edit outlet untuk ${memberName}` : null}</DialogTitle>
        </DialogHeader>
        <form
          onSubmit={(e) => {
            void handleSubmit(e);
...
function MembersBody() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
                  ...
                  <td colSpan={3} className="p-0">
                    <Empty>
                      <EmptyHeader>
                        ...
                        <EmptyTitle>
                          <Trans>Tidak ada undangan tertunda.</Trans>
                        </EmptyTitle>
                        <EmptyDescription>
      ...
      {/* ── Invite dialog ─────────────────────────────────────────────── */}
      <InviteDialog open={inviteOpen} onOpenChange={setInviteOpen} outlets={outletList} />
