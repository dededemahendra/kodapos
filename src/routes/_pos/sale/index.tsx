...
export const Route = createFileRoute('/_pos/sale/')({
  ...
  validateSearch: (s: Record<string, unknown>) => ({
    ...
    ...(typeof s.selfOrder === 'string' ? { selfOrder: s.selfOrder } : {}),
...
function SaleIndex() {
  const { recall, selfOrder, table } = Route.useSearch();
  ...
  return <SaleScreen recall={recall} selfOrder={selfOrder} table={table} />;
}
